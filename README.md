...
1. 本字体的调整参考《通用规范汉字表》、GF 0023-2020《通用规范汉字笔画规范》，以及其他遵循国标的楷体字形（如「教材规范楷体」），尽可能消除 Klee One 「直点」「断笔」印刷字体特征，符合楷体书写习惯。但部分字形差异视作风格不作改动，如：围字框「囗」等部件由于涉及字形数量较多，故保留 Klee 原风格，未做改动；此外限于 Klee 字体原有风格，不区分「悬针竖」和「垂露竖」。如有字形标准方面的改字疏漏，请在 [Issue #1](https://github.com/lxgw/LxgwGuiKai/issues/1) 提出，不要另开议题。
