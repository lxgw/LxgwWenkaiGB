...
1. 本字体的调整主要参考《通用规范汉字表》及教育部规范 GF 0023-2020《通用规范汉字笔顺规范》，并结合其他遵循国标的楷体、仿宋字形（如「教材规范楷体」），尽可能消除 Klee One 原有的「直点」「断笔」等传统印刷体特征，使字形更符合楷体书写习惯，字形的修改以 GB 18030-2022 实现级别 2 与[「霞鹜文楷 GB 轻便版」](https://github.com/lxgw/LxgwWenkaiGB-Lite)所收统一汉字的并集为限。但受个人审美、时间及工作量等因素影响，仍保留少量与规范楷书字形存在差异的细节，作为风格处理。例如，围字框「囗」等部件因涉及字形较多，保持 Klee 原有风格，未作改动；此外，限于 Klee 字体自身风格，本字体不区分「悬针竖」与「垂露竖」。因此，本字体**可能并不适合**义务教育图书、少儿读物、字帖等对规范字形要求**极高**的教育场合。
