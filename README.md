...
1. 本字体的调整参考《通用规范汉字表》、GF 0023-2020《通用规范汉字笔顺规范》，以及其他遵循国标的楷体、仿宋字形（如「教材规范楷体」），尽可能消除 Klee One 「直点」「断笔」等传统印刷字体特征，符合楷体书写习惯。但因个人审美、人力等因素，极少部分与规范楷书字形的细节差异视作风格不作改动，如：围字框「囗」等部件由于涉及字形数量较多，故保留 Klee 原风格，未做改动；此外限于 Klee 字体原有风格，不区分「悬针竖」和「垂露竖」。因此，本字体可能**并不适合**义务教育图书、少儿读物、字帖等对规范字形要求**极高**的教育场合。
